...
func (x *GetRequest) GetMovie() *Movie {
	if x != nil {
		return x.Movie
	}
	return nil
...
var file_models_movie_movie_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x1d, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x4d, 0x61, 0x6e, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x10, 0x5a, 0x0e,
	0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x6d, 0x6f, 0x76, 0x69, 0x65, 0x70, 0x62, 0x62, 0x06,
...
var file_models_movie_movie_proto_goTypes = []any{
	...
	(*GetResponse)(nil),     // 3: movie.GetResponse
...
var file_models_movie_movie_proto_depIdxs = []int32{
	...
	0,  // 1: movie.GetRequest.movie:type_name -> movie.Movie
	...
	4,  // 5: movie.MovieService.Get:input_type -> movie.GetRequest
	...
	3,  // 10: movie.MovieService.Get:output_type -> movie.GetResponse
